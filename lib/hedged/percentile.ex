defmodule Hedged.Percentile do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> buf = Hedged.Percentile.new()
      iex> buf.max_size
      1000

      iex> buf = Hedged.Percentile.new(50)
      iex> buf.max_size
      50
  ...
  ## Examples
      ...
      iex> buf = Hedged.Percentile.new() |> Hedged.Percentile.add(42)
      iex> buf.size
      1

      iex> buf = Hedged.Percentile.new(2) |> Hedged.Percentile.add(1) |> Hedged.Percentile.add(2) |> Hedged.Percentile.add(3)
      iex> buf.size
      2
  ...
  ## Examples
      ...
      iex> Hedged.Percentile.query(Hedged.Percentile.new(), 50)
      nil

      iex> buf = Enum.reduce(1..100, Hedged.Percentile.new(), &Hedged.Percentile.add(&2, &1))
      iex> Hedged.Percentile.query(buf, 50)
      50

      iex> buf = Enum.reduce(1..100, Hedged.Percentile.new(), &Hedged.Percentile.add(&2, &1))
      iex> Hedged.Percentile.query(buf, 95)
      95
